...
import { Prisma as PrismaClient, metodos_de_pagamento as MetodoPagamentoModel} from '../generated/prisma/client.js';
...
export class MetodosDePagamentoService {
  ...
  async update(params: {
    ...
    data: updateDto;}) : Promise<MetodoPagamentoModel> {
      try {
        ...
        if (params.data.nome) {
          updateData.metodo_de_pagamento_nome = params.data.nome.trim().toUpperCase();
        }
